    ...
    st.markdown(
        ...
        <div style="text-align:center; padding: 12px 0 20px 0;">
            <div style="font-size:1.6rem; font-weight:800; letter-spacing:0.5px;">
                <span style="color:#00c2a8;">100</span><span style="color:#e6e6e6;">era</span>
            </div>
            <div style="font-size:0.75rem; color:#8a8a8a; margin-top:2px;">
...
if analyze_clicked:
    if not ioc_input or not ioc_input.strip():
        ...
        try:
            ...
            st.warning(
                "AI insight is currently unavailable. Source analysis is still available above."
            )
...
st.markdown(
    """
    <div style="text-align:center; padding-top:32px; opacity:0.6; font-size:0.8rem;">
        Crafted with 🔍 by <span style="color:#00c2a8; font-weight:700;">100</span><span style="font-weight:700;">era</span>
    </div>
    """,
    unsafe_allow_html=True,
)
